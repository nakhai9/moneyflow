...
type ExpenseTrackerSnackbarProps = {
    open: boolean;
...
const ExpenseTrackerSnackbar: FC<ExpenseTrackerSnackbarProps> = ({ positions = "top-center", severity = "success", message, open, onClose }) => {
    return (<>
...
export default ExpenseTrackerSnackbar;